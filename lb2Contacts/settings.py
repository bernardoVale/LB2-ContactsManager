...
#Utilizado para as paginas que necessitam login
LOGIN_URL = '/login/'
...
INSTALLED_APPS = (
    ...
    'lb2Contacts.contatos',
    'django.contrib.admin',
    'django.contrib.admindocs',
)

TEST_RUNNER = 'lb2Contacts.contatos.testrunner.MongoTestRunner'
...
MONGO_DATABASE_NAME = 'lb2Contacts'
